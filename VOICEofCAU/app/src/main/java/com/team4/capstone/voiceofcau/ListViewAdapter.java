...
public class ListViewAdapter extends BaseAdapter implements Filterable {
    ...
    public void addItem(Drawable icon, String title, String desc, String path) {
        ListViewItem item = new ListViewItem();
        item.setIcon(icon);item.setTitle(title); item.setPath(path);
        item.setDesc(desc);listViewItemList.add(item);
    }
